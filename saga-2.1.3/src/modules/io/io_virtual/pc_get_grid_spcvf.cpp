/**********************************************************
 * Version $Id: pc_get_grid_spcvf.cpp 2277 2014-10-07 13:17:58Z reklov_w $
 *********************************************************/
...
//---------------------------------------------------------
bool CPointCloud_Get_Grid_SPCVF_Interactive::On_Execute_Position(CSG_Point ptWorld, TSG_Module_Interactive_Mode Mode)
{
	switch( Mode )
	{
	//-----------------------------------------------------
